...
from pydero import Contract,Connection,from_dero
import requests
#specify the scid
...
#conn = Connection('http://127.0.0.1:30309','62.210.79.219:30306')
...
#print(contract.get_abi())
print(contract.get_attribute(['number','string1','string2','number']))
